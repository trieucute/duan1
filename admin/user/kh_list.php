<!--  người dùng -->
<div class="container-row-content nhan_vien khach_hang_show"style="<?php echo (isset($_SESSION['user']['vai_tro']) && $_SESSION['user']['vai_tro'] == 'Nhân viên') ? 'display: none;' : '' ?>">
        ...
        <div class="list-chart" style="  margin-top: 70px;">
            <table class="sp-table">
                ...
                <?php
                $id_user = 1;
                $sql_user = "SELECT * FROM user LEFT JOIN khachhang ON user.ma_user = khachhang.ma_user where vai_tro ='Khách hàng' " ;
