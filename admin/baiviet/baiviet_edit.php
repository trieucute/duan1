...
<div class="container-row-content bai_viet_edit">
        ...
        <form action="" class="form-add-hh" style="margin-top: 40px" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group-hh" style="width: 50%">
                ...
                <input name="news_author_update" type="text" id="" value="<?php echo $row_edit_news['tac_gia'] ?>" class="form-control-hh" />
            </div>
            <div class="form-group-hh" style="width: 50%">
                <label for="">Mô tả</label>
                <input name="news_desc_update" type="text" value="<?php echo $row_edit_news['mo_ta'] ?>" class="form-control-hh" />
            </div>
            <div class="form-group-hh" style="width: 50%">
