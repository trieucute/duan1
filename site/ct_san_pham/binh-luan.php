<div class=" panel panel-default shadow-none mt-4">
    <h3 style="background-color: #E0E0E0;font-family: Mergeblack;" class="fw-bold p-3 rounded-top  fs-4  ">Bình Luận:</h3>
        ...
        <ul class="list-unstyle text-dark fw-bold fs-5 d-flex justify-content-between ps-3" style="flex-wrap: wrap !important;
            ...
            foreach ($binh_luan_list as $bl) {
                if ($bl['ho_ten'] != "") {
                    ...
                    echo "<li style=' width:100% !important ' ><li>$bl[noi_dung] </li> <li> -  Ẩn danh : $bl[ngay_bl] </li></li>";
                }
            }
