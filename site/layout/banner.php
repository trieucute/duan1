			...
			<div class="carousel-item active" style="height: 39rem; width: 100%;">
				...
				<div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
					<div class="p-3" style="max-width: 700px;">
						...
						<h3 class="display-4 text-white font-weight-semi-bold mb-4">Thời trang người trưởng thành</h3>
						<a href="../sanpham/shop.php" class="btn btn-light py-2 px-3">MUA NGAY</a>
					</div>
				</div>
			</div>
